      ...
      <div className={`${styleContainer.container} ${style.worksContainer}`}>
       <Title text={"My projects"}/>
        <div className={style.works}>
          ...
          <Project style={wordMeaning} title={"Words meaning"} description={"Application for learning English. Used technologies: TypeScript, React, Redux, Redux Thunk, Axios"} link={"https://words-meanings.herokuapp.com"}/>
          <Project style={linksChecker} title={"Backlinks checker"} description={"Application aimed at SEO-specialists to check the presence of a link in an article and indexing status in Google.. Used technologies: TypeScript, React, Redux, Redux Thunk, Axios, Material UI, Jest, XLSX"} link={"https://links-checker-demo.herokuapp.com"}/>
        </div>
      </div>
      </Fade>
    </div>
